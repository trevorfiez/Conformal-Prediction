...
tf.app.flags.DEFINE_string('eval_dir', '/scratch/tfiez/conformal/cifar10/bincross/class_weight_eval',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'test',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', '/scratch/tfiez/conformal/cifar10/bincross/balanced_models',
